...
//#pragma endregion
	...
	Car* car = new Car(glm::vec3(0,0,0));
	car->SetScale(glm::vec3(0.5, 0.5, 0.5));
	car->SetPosition(glm::vec3(-30, 0, 5));
	car->SetRotation(glm::vec3(0, 1, 0), 90);
	car->AddAnimation(new TranslateZ_Animation(2,0.01f));
