...
void House::AddComponents()
{
	...
	{
		Pyramid* top = new Pyramid(glm::vec3(0.588, 0.294, 0.), ShadingType::Basic);
	...
	{
		TriangularPrism* top1 = new TriangularPrism(glm::vec3(0.588, 0.294, 0.), ShadingType::Basic);
		...
		TriangularPrism* top2 = new TriangularPrism(glm::vec3(0.588, 0.294, 0.), ShadingType::Basic);
	...
	Cube* base = new Cube(glm::vec3(0.961, 0.961, 0.863), ShadingType::Basic);
	base->Move(position);
	...
	Cube* chimney = new Cube(glm::vec3(0.29, 0.157, 0.027), ShadingType::Basic);
