#include "MoveLeftAnimation.h"

MoveLeftAnimation::MoveLeftAnimation(float Goal, float AnimateValue, bool Negative)
{
	this->Goal = Goal;
...
glm::mat4 MoveLeftAnimation::Animate(glm::mat4 model)
{
