...
{
	Plane* plane = new Plane(glm::vec3(0.173, 0., 0.8),ShadingType::Basic);
	...
	road->SetPosition(glm::vec3(5, 0.01, 0));
	...
	fence->SetPosition(glm::vec3(0.0f, 0.0f, 2.0f));
	...
	bench->SetPosition(glm::vec3(0.0f, 0.02f, 5.0f));
	bench->SetScale(glm::vec3(2, 2, 2));

	TrashBin* trashbin = new TrashBin(glm::vec3(0, 0, 3));
	

	TriangularPrism* TP = new TriangularPrism(glm::vec3(0.173, 0., 0.8), ShadingType::Basic);
	TP->SetPosition(glm::vec3(4, 0, 0));
